export const VIEWS = [
  { id: 'dashboard', label: 'Dashboard & Twin', sub: 'See and control your store screen' },
  { id: 'playlist', label: 'Slideshow Studio', sub: 'Pick photos & videos and set how they change' },
  { id: 'videogrid', label: 'Video Grid Player', sub: 'Show two screens side by side' },
  { id: 'ticker', label: 'Live Ticker Bar', sub: 'Add a scrolling text line' },
  { id: 'cloud', label: 'Media Cloud', sub: 'All your photos and videos in one place' },
  { id: 'namaste', label: 'Namaste Intro Screen', sub: 'Welcome screen for your kiosk' },
  { id: 'vault', label: 'AI Try-On Captures', sub: 'Photos your kiosk made in the last 24 hours' },
  { id: 'credits', label: 'Credit Allocator', sub: 'Move available credits between screens' },
  { id: 'catalog', label: 'AI Fashion & Beauty Catalog', sub: 'Pick styles for customers to try on' },
  { id: 'fleet', label: 'Fleet Overview', sub: 'Check how every store screen is doing', scope: 'super' },
  { id: 'globalcredits', label: 'Global Credit Pool', sub: 'Share credits between all your stores', scope: 'super' },
  { id: 'firmware', label: 'Firmware Scheduler', sub: 'Update kiosk software at quiet times', scope: 'super' },
  { id: 'syndicate', label: 'Master Syndication', sub: 'Send one campaign to many kiosks at once', scope: 'super' },
]
